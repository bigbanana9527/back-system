<template>
  ...
  <el-tabs v-model="activeName" @tab-click="handleTabClick">
    ...
    <el-tab-pane label="动态参数" name="many">
        <el-button type="primary" size="mini" :disabled="isBtnDisanled" @click="addDialogVisible=true">添加参数</el-button>
        <!-- 动态参数表格 -->
    ...
    <el-tab-pane label="静态属性" name="only">
        <el-button type="primary" size="mini" :disabled="isBtnDisanled" @click="addDialogVisible=true">添加属性</el-button>
